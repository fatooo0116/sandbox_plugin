<?php
/*
    Plugin Name: TabPay payment gateway
    Plugin URI: https://aloha-tech.com/
    Description: TabPay payment
    Version: 1.1.0
    Author: Mike Hsu
*/
...
function wc_tappay_add_to_gateways( $gateways ) {
    $gateways[] = 'WC_Gateway_TAPPAY';
    return $gateways;
}
add_filter( 'woocommerce_payment_gateways', 'wc_tappay_add_to_gateways' );




add_action( 'plugins_loaded', 'wc_tappay_gateway_init', 11 );

function wc_tappay_gateway_init() {


        class WC_Gateway_TAPPAY extends WC_Payment_Gateway {
            ...
            public function __construct() {
                ...
                $this->method_title       = __( 'Tappay Payment', 'woocommerce' );
                $this->method_description = __( 'Tappay Simple Payment' );
            ...
            public function save_account_details() {
                ...
                update_option( 'woocommerce_bacs_accounts1', $accounts );
            }
